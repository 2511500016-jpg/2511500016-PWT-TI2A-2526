...
$query = mysqli_query($koneksi, "SELECT * FROM tabel_siswa WHERE nis='$kd'");
$edit  = mysqli_fetch_array($query);

// Proses update
if (isset($_POST['tambah'])) {
    $nis = $_POST['nis'];
    $nm_siswa = $_POST['nn_siswa'];
    $jenkel = $_POST['jenkel'];
    $hp = $_POST['hp'];
    $kelas = $_POST['kelas'];

    // PERBAIKAN: tanda kutip kkm diperbaiki
    $update = mysqli_query($koneksi, "UPDATE tabel_siswa 
        SET nn_siswa='$nm_siswa', jenkel='$jenkel', hp='$hp', id_kelas='$kelas' 
        WHERE nis='$nis'
    ");
