...
<?php
$carikode = mysqli_query($koneksi, "SELECT MAX(id_jadwal) FROM jabwal_kelas") or die(mysqli_error($koneksi));
...
$id_jadwal = mysqli_insert_id($koneksi);
    ...
    for ($i = 0; $i < count($kd_mapel); $i++) {
        $insert = mysqli_query($koneksi, "INSERT INTO detail_jadwal (id_jadwal, kd_guru, kd_mapel, hari, jam_mulai, jam_selesai)
        VALUES ('$id_jadwal', '$kd_guru', '{$kd_mapel[$i]}', '{$hari[$i]}', '{$jam_mulai[$i]}','{$jam_selesai[$i]}')");
            ...
            <div class="card-body">
                ...
                <form method="post" action="">
                    <div class="form-group">
                        ...
                        <input type="text" name="kd_jadwal" value="<?php echo $hasilkode ?>" class="form-control" readonly>
                    </div>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-md-3">
                                <select name="kelas[]" class="form-control" required>
                                    ...
                                    <?php
                                    $kelas = mysqli_query($koneksi, "SELECT * FROM tabel_kelas");
