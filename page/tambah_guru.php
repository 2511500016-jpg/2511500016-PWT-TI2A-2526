...
if(isset($_POST['tambah'])){
    ...
    $cek = mysqli_query($koneksi, "SELECT * FROM tabel_guru WHERE Kd_guru = '$kd_guru'");
    if(mysqli_num_rows($cek) > 0) {
        ...
        $insert = mysqli_query($koneksi, "INSERT INTO tabel_guru (Kd_guru, Nm_guru, Jenkel, Pend_terakhir, Hp, Alamat) 
