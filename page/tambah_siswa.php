...
if (isset($_POST['tambah'])) {
    $nis = $_POST['nis'];
    $nn_siswa = $_POST['nn_siswa'];
    $jenkel = $_POST['jenkel'];
    $hp = $_POST['hp'];
    $kelas = $_POST['kelas'];

    $insert = mysqli_query($koneksi, "INSERT INTO tabel_siswa VALUES ('$nis', 1, '$nn_siswa', '$jenkel', '$hp', '$kelas')");
    $insertUser = mysqli_query($koneksi, "INSERT INTO tabel_user (username, password, role) VALUES ('$nis', '1234', 'siswa')");
        ...
        <div class="card">
            <div class="card-body p-2">
                ...
                <form method="POST" action="">
                    ...
                    <div class="form-group">
                        <label for="nn_siswa">Nama siswa</label>
                        <input 
                            type="text" 
                            name="nn_siswa" 
                            id="nn_siswa"
